...
const replyy = (teks) => {
return rxhl.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": `RILL DEVELOPER 🌛`,"body": `Hai ${pushname}`, "previewType": "PHOTO","thumbnail": rxhlimage,"sourceUrl": `https://www.youtube.com/@rilyzy`}}}, { quoted:m})} 
...
"sourceUrl": "https://whatsapp.com" }}}, { quoted: m }) }
...
hohe = [
  {
                'name': 'single_select',
                'buttonParamsJson': "{'title':'RIL OFC','sections':[{'title':'Pilihan Premium!','highlight_label':'Berbayar','rows':[{'header':'','title':'BOT VIP BY RIL OFC','description':'Telegram: @r','id':'.kontplbinatang'}]}]}"
              },
              {
   name: "cta_url",
   buttonParamsJson: JSON.stringify({
      display_text: "My Channel",
      url: "https://ww.youtube.com/@rilyzy",
      merchant_url: "https://ww.youtube.com/@rilyzy"
   })
}
]
ewe = `┏❐  ⌜ RILL - Bot - V6 ⌟  ❐
┃⭔ Creator : RILLOfficial
┃⭔ Partner : -
┃⭔ Type : Case
┃⭔ Status : Online
...
hohe = [
  {
                'name': 'single_select',
                'buttonParamsJson': "{'title':'RILL OFC','sections':[{'title':'Pilihan Premium!','highlight_label':'Berbayar','rows':[{'header':'','title':'BOT VIP BY RILL OFC','description':'Telegram: @r','id':'.kontplbinatang'}]}]}"
              },
              {
   name: "cta_url",
   buttonParamsJson: JSON.stringify({
...
┏❐   \`Special Bug\`
┃
┃⭔ ${prefix}rilbug *628xxx|Amount*
┃⭔ ${prefix}rilkeren *628xxx|Amount*
┃⭔ ${prefix}rilganteng *628xxx|Amount*
┃⭔ ${prefix}rillios *628xxx|Amount*
┃⭔ ${prefix}rilandro *628xxx|Amount*
┃
┗❐
...
hohe = [
  {
                'name': 'single_select',
                'buttonParamsJson': "{'title':'RILL OFC','sections':[{'title':'Pilihan Premium!','highlight_label':'Berbayar','rows':[{'header':'','title':'BOT VIP BY RILL OFC','description':'Telegram: @rxhlvro','id':'.kontplbinatang'}]}]}"
              },
              {
   name: "cta_url",
   buttonParamsJson: JSON.stringify({
...
hohe = [
  {
   ...
   buttonParamsJson: JSON.stringify({
      display_text: "My Channel",
      url: "https://ww.youtube.com/@rilyzyc",
      merchant_url: "https://ww.youtube.com/@rilyzy"
   })
}
]
...
hohe = [
  {
                'name': 'single_select',
                'buttonParamsJson': "{'title':'RILL OFC','sections':[{'title':'Pilihan Premium!','highlight_label':'Berbayar','rows':[{'header':'','title':'BOT VIP BY RILL OFC','description':'Telegram: @ro','id':'.kontplbinatang'}]}]}"
              },
              {
   name: "cta_url",
   buttonParamsJson: JSON.stringify({
...
hohe = [
  {
   ...
   buttonParamsJson: JSON.stringify({
      display_text: "",
      url: "https://www.youtube.com/@rilyzy",
      merchant_url: "https://www.youtube.com/@rilyzy"
   })
}
]
ewe = `${menuu}`
